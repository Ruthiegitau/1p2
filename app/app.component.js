        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.meals = [
                        new meal_model_1.Meal("chips", "sweer", 500),
                        new meal_model_1.Meal("chapo madondo", "hustler mode", 30),
                        new meal_model_1.Meal("bajia", "with mkwaju", 100),
                        new meal_model_1.Meal("pilau", "with kachumbari", 65),
                    ];
                }
